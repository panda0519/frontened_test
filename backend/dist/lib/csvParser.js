...
var DATA_DIR = node_path_1.default.join(__dirname, "..", "..", "data");
function parseCsvFile(fileName) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, fileContent, records, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = node_path_1.default.join(DATA_DIR, fileName);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    ...
                    throw new Error("Failed to parse CSV file ".concat(filePath, ": ").concat(error_1 instanceof Error ? error_1.message : String(error_1)));
